...
import {fetchName, fetchPrice, fetchSymbol, fetchTokenUri, fetchTotalSupply} from "./utils/erc-721";

// Constants
let CONTRACT_ADDRESS = "0x7097b965E3540Ab3B595855e57A4D584Ef5332b5";
...
export function handleTransfer(event: Transfer): void {
  ...
  if (contract === null) {
    ...
    contract.floorPrice = ZERO_BI;
    contract.totalSpent = ZERO_BI;
    contract.save();
  }
  ...
  if (token === null) {
    ...
    contract.totalSpent = contract.totalSpent.plus(fetchPrice());
    contract.floorPrice = contract.totalSpent.div(contract.totalTokens);
    contract.save();
  }
  token.owner = to.id;
