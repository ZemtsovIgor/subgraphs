...
export class TBCCFinanceFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save TBCCFinanceFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save TBCCFinanceFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("TBCCFinanceFactory", id.toString(), this);
  }

  static load(id: string): TBCCFinanceFactory | null {
    return store.get("TBCCFinanceFactory", id) as TBCCFinanceFactory | null;
  }
...
export class TBCCFinanceDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save TBCCFinanceDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save TBCCFinanceDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("TBCCFinanceDayData", id.toString(), this);
  }

  static load(id: string): TBCCFinanceDayData | null {
    return store.get("TBCCFinanceDayData", id) as TBCCFinanceDayData | null;
  }
