...
import { TBCCFinanceFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = TBCCFinanceFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new TBCCFinanceFactory(FACTORY_ADDRESS);
