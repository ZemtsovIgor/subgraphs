...
export class Contract extends Entity {
  ...
  get busdPrice(): BigInt {
    let value = this.get("busdPrice");
    return value.toBigInt();
  }

  set busdPrice(value: BigInt) {
    this.set("busdPrice", Value.fromBigInt(value));
  }
...
export class Referral extends Entity {
  ...
  static load(id: string): Referral | null {
    return store.get("Referral", id) as Referral | null;
  }
  ...
  set inviter(value: string) {
    this.set("inviter", Value.fromString(value));
  }
}
...
export class Inviter extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save Inviter entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save Inviter entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("Inviter", id.toString(), this);
  }

  static load(id: string): Inviter | null {
    return store.get("Inviter", id) as Inviter | null;
  }
  ...
  get referral(): Array<string> {
    let value = this.get("referral");
    return value.toStringArray();
  }

  set referral(value: Array<string>) {
    this.set("referral", Value.fromStringArray(value));
  }
