...
export class Profile extends ethereum.SmartContract {
  ...
  b8dToken(): Address {
    let result = super.call("b8dToken", "b8dToken():(address)", []);

    return result[0].toAddress();
  }

  try_b8dToken(): ethereum.CallResult<Address> {
    let result = super.tryCall("b8dToken", "b8dToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  numberB8DToReactivate(): BigInt {
    let result = super.call(
      "numberB8DToReactivate",
      "numberB8DToReactivate():(uint256)",
      []
    );
  ...
  try_numberB8DToReactivate(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "numberB8DToReactivate",
      "numberB8DToReactivate():(uint256)",
      []
  ...
  numberB8DToRegister(): BigInt {
    let result = super.call(
      "numberB8DToRegister",
      "numberB8DToRegister():(uint256)",
      []
    );
  ...
  try_numberB8DToRegister(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "numberB8DToRegister",
      "numberB8DToRegister():(uint256)",
      []
  ...
  numberB8DToUpdate(): BigInt {
    let result = super.call(
      "numberB8DToUpdate",
      "numberB8DToUpdate():(uint256)",
      []
    );
  ...
  try_numberB8DToUpdate(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "numberB8DToUpdate",
      "numberB8DToUpdate():(uint256)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get _b8dToken(): Address {
    return this._call.inputValues[0].value.toAddress();
  }

  get _numberB8DToReactivate(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _numberB8DToRegister(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }

  get _numberB8DToUpdate(): BigInt {
...
export class UpdateNumberB8DCall extends ethereum.Call {
  get inputs(): UpdateNumberB8DCall__Inputs {
    return new UpdateNumberB8DCall__Inputs(this);
  }

  get outputs(): UpdateNumberB8DCall__Outputs {
    return new UpdateNumberB8DCall__Outputs(this);
  }
}

export class UpdateNumberB8DCall__Inputs {
  _call: UpdateNumberB8DCall;

  constructor(call: UpdateNumberB8DCall) {
    this._call = call;
  }

  get _newNumberB8DToReactivate(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _newNumberB8DToRegister(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }

  get _newNumberB8DToUpdate(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }
}

export class UpdateNumberB8DCall__Outputs {
  _call: UpdateNumberB8DCall;
