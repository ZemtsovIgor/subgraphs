...
import {
  ...
  RevenueClaim,
  Trade,
} from "../generated/B8DEXNFTMarket/B8DEXNFTMarket";
import { toBigDecimal } from "./utils";
import { updateCollectionDayData, updateMarketPlaceDayData } from "./utils/dayUpdates";
import { fetchNftId, fetchName, fetchSymbol, fetchTokenURI } from "./utils/erc721";

// Constants
let ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";
let B8DEX_MAIN_COLLECTION_ADDRESS = "0x0304f29b4178d371bFc8B41aA9431848fbde6145";
...
export function handleAskNew(event: AskNew): void {
  ...
  if (token === null) {
    ...
    if (event.params.collection.equals(Address.fromString(B8DEX_MAIN_COLLECTION_ADDRESS))) {
      token.otherId = fetchNftId(event.params.collection, event.params.tokenId);
    }
